...
namespace BanCoppel.Util
{
    public class GeneratorXML
    {
        ...
        public GeneratorXML(string rutaOrigen, int numArchivosParaProcesar,
            ...
            string fechaHoraInicioFin, string estatusGeneralProceso, string descEstatusGeneralProceso, string nomLog) // Nuevo parámetro para la ruta de destino
            {
        ...
        {
            string? rutaDestinoLog = ConfigurationManager.AppSettings.Get("RutaLogWin") ?? "";
